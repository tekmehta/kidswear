...
const Footer = () => {
    return(
        <>
            <footer className="py-12 bg-cyan-50">
                <hr/>
                ...
                <div className="col-span-3 ">
                    ...
                    <div>
                        <p className="border p-2 rounded-[50%]">
                        <svg
                ...
                <hr/>
                <div className="flex justify-between items-center flex-wrap gap-12 p-2 pr-10 pl-12 mr-12 ml-12 text-gray-500 text-xs">         {/* this div appearin bottom left side of the page  */}
                ...
                <div className="col-span-4 flex flex-rows gap-5">  {/* this div appear in bottom lright side of the page  */}
                    <select name="" id="">
